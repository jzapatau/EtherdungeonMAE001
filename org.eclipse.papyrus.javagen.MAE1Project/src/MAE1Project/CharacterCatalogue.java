...
public enum CharacterCatalogue {
	HERO(new String[]{"Lionel Messi", "Diego Maradona", "Hugo Porta", "Jorge L. Borges", "Felipe Contempomi"}),
	MONSTER(new String[]{"Jorge Videla", "Margaret Thatcher", "General Peron", "Che Guevara", "Ronald Reagan"});
	...
	private <T extends Individual, Q extends Catalog> User<T> generateVirtualUser(Settings settingObj, String userName, Q[] options) {
		...
		for (int i=0; i < settingObj.numberOfMembersinTeam; i++) {
			...
			charName = this.getDefaultName()[i];
